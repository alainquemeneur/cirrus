...
char *nom,*mdp,*code,*quota,*musicviewmode;
...
musicviewmode=(char*)malloc(query_size);
...
tamb(code);
get_chaine(envoi,1,musicviewmode);
tamb(musicviewmode);
...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
            <ul>\n\
               ...
               <form target=\"upload\" action=\"/cgi-bin/cirrus_add.cgi\" method=\"post\" id=\"form-add\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <input type=\"hidden\" name=\"txt-mode\" id=\"txt-mode\" value=\"musique\">\n\
                  <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"plus\" class=\"ui-shadow\">Ajouter</button>\n\
                  </form>\n",nom,mdp,code);
   printf("</li>\n\
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_music_share.cgi\" method=\"post\" id=\"form-share\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
               ...
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_music_suppr.cgi\" method=\"post\" id=\"form-suppr\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-musicviewmode\" id=\"txt-musicviewmode\" value=\"%s\">\n\
      ...
      <div role=\"main\" class=\"ui-content\" data-theme=\"b\">\n\
         ...
         <hr>\n",nom,mdp,code,musicviewmode,nom,mdp,code,musicviewmode,start,quota);
	sprintf(query,"update compte set musicviewmode=\'%s\' where nom=\'%s\';",musicviewmode,nom);
	db_query(handler,query);
	db_clear_result(result);
	strcpy(reponse," order by nom asc");
	if(strcmp(musicviewmode,"noma")==0) strcpy(reponse," order by nom asc");
	if(strcmp(musicviewmode,"nomd")==0) strcpy(reponse," order by nom desc");
	if(strcmp(musicviewmode,"datea")==0) strcpy(reponse," order by id asc");
	if(strcmp(musicviewmode,"dated")==0) strcpy(reponse," order by id desc");
	sprintf(query,"select nom,lien,id from entree where owner=\'%s\' and zone=\'musique\'%s;",nom,reponse);
	db_query(handler,query);
	for(i=0;i<db_ntuples(result);i++)
		{
		db_getvalue(result,i,0,reponse,200);
      ...
      printf("<audio src=\"%s\" controls></audio>\n",reponse);
   ...
   printf("<div data-role=\"fieldcontain\">\n\
         <form action=\"/cgi-bin/cirrus_musiques.cgi\" method=\"post\" id=\"form-trin-asc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_musiques.cgi\" method=\"post\" id=\"form-trin-desc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_musiques.cgi\" method=\"post\" id=\"form-trid-asc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_musiques.cgi\" method=\"post\" id=\"form-trid-desc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
