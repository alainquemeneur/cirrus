...
<div data-role=\"page\" data-theme=\"b\">\n\
      ...
      <br><br>\n\
Veuillez confirmer la suppression de cette image\n\
<form action=\"/cgi-bin/cirrus_image_dosuppr.cgi\" method=\"post\" id=\"form-suppr\" data-transition=\"none\" data-rel=\"dialog\">\n\
<input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
...
</html>\n",nom,mdp,code,mode,nom,mdp,code,mode,selection);
	}
if(success==2)
	{
	printf("Content-Type: text/html\n\n\
