...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
            <ul>\n\
               ...
               <form target=\"upload\" action=\"/cgi-bin/cirrus_add.cgi\" method=\"post\" id=\"form-add\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <input type=\"hidden\" name=\"txt-mode\" id=\"txt-mode\" value=\"pageweb\">\n\
                  <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"plus\" class=\"ui-shadow\">Ajouter</button>\n\
                  </form>\n",nom,mdp,code);
   printf("</li>\n\
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_pageweb_share.cgi\" method=\"post\" id=\"form-share\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
               ...
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_pageweb_suppr.cgi\" method=\"post\" id=\"form-suppr\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-viewmode\" id=\"txt-viewmode\" value=\"%s\">\n\
         ...
         <h1><img srcset=\"/cirrus/pageweb.png 1.5x\"></h1>\n\
      </div>\n\
      <div role=\"main\" class=\"ui-content\" data-theme=\"b\">\n\
         <p>Espace disque utilisé : %d Go sur %s Go</p>\n\
         <hr>\n",nom,mdp,code,viewmode,nom,mdp,code,viewmode,start,quota);
	sprintf(query,"update compte set pagewebviewmode=\'%s\' where nom=\'%s\';",viewmode,nom);
	db_query(handler,query);
	db_clear_result(result);
	...
	sprintf(query,"select nom,lien,id from entree where owner=\'%s\' and zone=\'pageweb\'%s;",nom,reponse);
	db_query(handler,query);
	for(i=0;i<db_ntuples(result);i++)
		{
		db_getvalue(result,i,0,reponse,200);
      ...
      printf("<a href=\"%s\" target=\"pageweb\"><img src=\"/cirrus/html.png\"></a>\n",reponse);
   ...
   printf("<div data-role=\"fieldcontain\">\n\
         <form action=\"/cgi-bin/cirrus_pagesweb.cgi\" method=\"post\" id=\"form-trin-asc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_pagesweb.cgi\" method=\"post\" id=\"form-trin-desc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_pagesweb.cgi\" method=\"post\" id=\"form-trid-asc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_pagesweb.cgi\" method=\"post\" id=\"form-trid-desc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
