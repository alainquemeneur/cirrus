...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
            <ul>\n\
               ...
               <form target=\"upload\" action=\"/cgi-bin/cirrus_add.cgi\" method=\"post\" id=\"form-add\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <input type=\"hidden\" name=\"txt-mode\" id=\"txt-mode\" value=\"image\">\n\
                  <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"plus\" class=\"ui-shadow\">Ajouter</button>\n\
                  </form>\n",nom,mdp,code);
   printf("</li>\n\
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_image_share.cgi\" method=\"post\" id=\"form-share\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
               ...
               <li>\n\
                  <form action=\"/cgi-bin/cirrus_image_suppr.cgi\" method=\"post\" id=\"form-suppr\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-viewmode\" id=\"txt-viewmode\" value=\"%s\">\n\
	...
	sprintf(query,"update compte set imageviewmode=\'%s\' where nom=\'%s\';",viewmode,nom);
	db_query(handler,query);
	db_clear_result(result);
	strcpy(reponse," order by id asc");
	if(strcmp(viewmode,"datea")==0) strcpy(reponse," order by id asc");
	if(strcmp(viewmode,"dated")==0) strcpy(reponse," order by id desc");
	sprintf(query,"select nom,lien,id from entree where owner=\'%s\' and zone=\'image\'%s;",nom,reponse);
	db_query(handler,query);
	for(i=0;i<db_ntuples(result);i++)
		{
		db_getvalue(result,i,1,reponse,200);
		printf("<img src=\"%s\" style=\"max-width:100%%; object-fit: contain;\"><br>",reponse);
   ...
   printf("<div data-role=\"fieldcontain\">\n\
         <form action=\"/cgi-bin/cirrus_images.cgi\" method=\"post\" id=\"form-trid-asc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
         ...
         <form action=\"/cgi-bin/cirrus_images.cgi\" method=\"post\" id=\"form-trid-desc\" data-transition=\"none\" data-rel=\"dialog\">\n\
         <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
         <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
