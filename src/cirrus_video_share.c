...
<body>\n\
   <div data-role=\"page\" data-theme=\"b\">\n\
      ...
      <div data-role=\"navbar\">\n\
            <ul>\n\
               <li>\n\
               <form action=\"/cgi-bin/cirrus_videos.cgi\" method=\"post\" id=\"form-add\" data-transition=\"none\" data-rel=\"dialog\">\n\
      ...
      Intégration de ce contenu dans une page web : <br><br><strong>&lt;video controls src=\"%s%s\" style=\"height:50vh; max-width:100%%; object-fit: contain;\" controls&gt;Votre navigateur ne supporte pas l'affichage des vidéos&lt;/video&gt;</strong><br><br>\n\
      Embed de la vidéo : <a href=\"%s/cgi-bin/cirrus_video_iframe.cgi?url=%s%s\">%s/cgi-bin/cirrus_video_iframe.cgi?url=%s%s</a>\n\
      </div>\n\
      <div data-role=\"footer\" class=\"ui-bar\" data-position=\"fixed\" data-theme=\"b\">\n\
<h4>Cirrus - Cloud privé</h4>\n\
</div>\n\
...
</html>",nom,mdp,code,viewmode,storage_dir,reponse,storage_dir,reponse,storage_dir,reponse,WEBSITE,storage_dir,reponse,WEBSITE,storage_dir,reponse);
	}
if(success==2)
	{
	printf("Content-Type: text/html\n\n\
