...
<body>\n\
   <div data-role=\"page\" data-theme=\"b\">\n\
      ...
      Lien pour intégrer ce contenu dans une page web : <br><br><strong>&lt;audio src=\"%s%s\" controls&gt;&lt;/audio&gt;</strong><br>\n\
...
</html>",nom,mdp,code,viewmode,storage_dir,reponse,storage_dir,reponse,storage_dir,reponse,reponse);
	}
if(success==2)
	{
	printf("Content-Type: text/html\n\n\
