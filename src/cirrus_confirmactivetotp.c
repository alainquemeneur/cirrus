...
if(succes==1)
	{
	printf("L'authentification à 2 facteurs protège l'accès à votre compte en ajoutant à votre login et mot de passe un code de vérification à 6 chiffres qui change toutes les 30 secondes. Ce code TOTP (time one time password) vous sera donné par l'application \"Google authenticator\" à installer sur votre smartphone. Installez Google authenticator sur votre smartphone <strong>AVANT</strong> d'activer la fonctionnalité 2FA dans Cirrus. Si vous confirmez l'activation du 2FA, la page suivante vous donnera un QR code à faire lire à Google authenticator.");
	printf("<form action=\"/cgi-bin/cirrus_activetotp.cgi\" method=\"post\" id=\"formconfirm\" data-transition=\"none\" data-rel=\"dialog\">\n\
	<input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
	<input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
	<input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
